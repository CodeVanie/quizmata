import { z } from "zod";
const accessEnum = ["public", "private", "class"];
const orderEnum = ["ordered", "reversed", "shuffle"];
...
function validatePassingScore(data, ctx) {
    const totalPoints = data.questions.reduce((sum, { questionPoint }) => sum + questionPoint, 0);
